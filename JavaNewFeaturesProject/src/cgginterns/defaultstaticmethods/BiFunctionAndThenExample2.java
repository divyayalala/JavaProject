...
public class BiFunctionAndThenExample2 {
	public static void main(String[] args) {
		BiFunction<String, Integer, Integer> bifunction = (designation, age) -> getSalaryBasedOnAge(designation, age);
	...
	private static Integer getSalaryBasedOnAge(String designation, Integer age) {
